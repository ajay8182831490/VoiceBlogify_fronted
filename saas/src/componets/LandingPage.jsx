            ...
            <div className="min-h-screen  flex flex-col items-center" style={{ backgroundColor: "#020012" }}>
                ...
                >
                    ...
                    <div className="relative z-10 container mx-auto px-6 text-center py-10" style={{ backgroundColor: "#020012" }}>
                        ...
                        >
                            <span className='text-white'>Turn Audio </span>
                            <span className="text-yellow-300">into Quick, Engaging Blog Posts</span>
                        </motion.h1>

                        <motion.p
                            className="text-lg md:text-xl mb-6 max-w-2xl mx-auto px-4 md:px-0 text-gray-300"
