...
function LoginForm1() { // Updated name here
    return (
        <form className="flex flex-col items-stretch pt-3 md:pt-8">
            <InputField type="email" id="login-email" placeholder="Email" />
            <InputField type="name" id="login-name" placeholder="name" />
            <InputField type="password" id="login-password" placeholder="Password (minimum 8 characters)" />
            <SubmitButton />
        </form>
    );
}
export function InputField({ type, id, placeholder }) {
    return (
