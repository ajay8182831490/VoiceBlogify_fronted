                            ...
                            <div className="hidden sm:ml-6 sm:block">
                                <div className="flex space-x-4">
                                    ...
                                    {!isPaidMember && (
                                        <a
                                            href="#start-free"
                                            className="bg-green-500 text-white rounded-xl px-3 py-2 text-sm font-medium hover:bg-green-700 hover:text-white"
                                        >
                                            Start Free
                                        </a>
                                    )}
